...
ANTHROPIC_MODEL_ID = "anthropic.claude-haiku-4-5-20251001-v1:0"
...
# --- Page Title ---
st.title("🤖 Anthropic Claude Chatbot (via AWS Bedrock)")
...
def get_llm(temp):
    return Bedrock(
        ...
        model_kwargs={"max_tokens": 1000, "temperature": temp},
...
if prompt := st.chat_input("Ask me anything..."):
    ...
    try:
        ...
        if llm.streaming:
            _ = llm.invoke(prompt, callbacks=[handler])
